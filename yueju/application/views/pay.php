...
<script src="assets/js/header.js"></script>
	<div id="order-state">
		<div class="wrapper">
			...
			<img src="assets/img/order1.jpg"class="is-order">
			<img src="assets/img/order3.jpg"class="pay-cash1">
			<img src="assets/img/order2.jpg"class="pay-cash2">
	...
	<div id="group-one">
		<div class="wrapper">
			<span class="pay-suc">支付成功!</span>
			<span class="click"><a href="javascript:;">点击此，跳转个人中心&gt;</a></span>
		</div>
	</div>
	<div id="group-three">
		<div class="wrapper">
			...
			<div id="live">
				...
				<span class="livetotal">共两晚</span>
			</div>
			<div class="line1"></div>
			<div id="will-order">预订信息:</div>
			<div class="will-more">
				<span class="will-na">姓名: </span>
				<span class="will-name"><?php echo $this->session->userdata('name');?></span>
			...
			<div>
				...
				<div>
					...
					<span class="get-price">¥100.00</span>
				</div>
			</div>
		</div>
	</div>
