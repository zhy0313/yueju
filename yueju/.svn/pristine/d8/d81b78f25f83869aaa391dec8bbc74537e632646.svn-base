...
<head>
	...
	<link rel="stylesheet" href="assets/css/order_wechat.css">
	<title>订单提交页</title>
...
<body>
	<div id="gap"></div>
	<div id="order-suc">
		<div class="one">订单提交成功!</div>
		<div class="two">确认后,&nbsp;&nbsp;我们后发送短信通知您支付定金</div>
	</div>
	<div class="line1"></div>
	...
	<div class="line4"></div>
	<div id="on-money">在线收取押金: 200元</div>
	...
	<div class="line6"></div>
	<div id="pay-way">支付方式</div>
	<div id="alipay">支付宝</div>
	<div id="wechat">微信</div>
	<div id="is-pay">确认支付</div>
	<div id="return">返&nbsp;&nbsp;&nbsp;&nbsp;回</div>

	<script src="assets/js/zepto.min.js"></script>
	<script src="assets/js/order_wechat.js"></script>
</body>
</html>