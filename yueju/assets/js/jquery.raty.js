        ...
        init: function(settings) {
            return this.each(function() {
                ...
                var space  = this.opt.space ? 4 : 0,
                    width  = this.opt.width || (this.opt.number * this.opt.size + this.opt.number * space+50);
            ...
            for (var i = 1; i <= this.opt.number; i++) {
                ...
                $('<img />', { src : icon, alt: i, title: title ,style:"margin-right:5px"}).appendTo(this);

                if (this.opt.space) {
                    // that.append((i < this.opt.number) ? 'style="margin-right:5px;"' : '');
                }
            }
