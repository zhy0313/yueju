...
<section class="panel">
    ...
    <div class="panel-body">
        <form id="add_form" role="form" action="admin/do_add_house" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="row col-lg-12" id="select_img">
                    ...
                    <input type="button" class="btn btn-primary" value="开始上传" id="upload-btn" />(注意勾选设置主图)
                    <ul id="file-list">
                    </ul>
<!--                    <pre id="console"></pre>-->
                </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <input type="submit" value="提交房源信息" class="btn btn-primary">
