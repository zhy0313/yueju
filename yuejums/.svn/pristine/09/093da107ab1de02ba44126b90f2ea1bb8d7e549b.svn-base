...
<span class="caret"></span>
        ...
        <div class="wrapper">
             <div class="row">
                ...
                <form action="collection/index" method="post">
...
<!--                    </div>-->
                    <div class="btn-group pull-right">
                        模糊查询： <input type="text" name="search" placeholder="请输入房源标题" value="">
...
<!--                    <th>ID</th>-->
                ...
                <?php foreach($rs as $v){?>
                    <tr class="ms">
                        ...
                        <td><?php echo $v->city.' '.$v->street.' '.$v->road;?></td>
                        <td><?php echo $v->collect_time?></td>
                    </tr>
                <?php }?>
                </tbody>
                </table>
...
<!--                    <div class="row">-->
<!--                        <div class="col-lg-6">-->
<!--                            <div class="dataTables_info">共--><?php //echo count($rs);?><!--条记录</div>-->
<!--                        </div>-->
<!--                        <div class="col-lg-6">-->
...
<script>
    $(function(){
        $('#sub').on('click',function(){
            location.href='collection/index/' + '?search=<?php echo $search?>';
        });
    });
</script>
